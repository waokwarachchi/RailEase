...
public class TrainActivity extends AppCompatActivity implements ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new TrainAdapter(this, busList);
                        ...
                        FirebaseDatabase.getInstance().getReference()
                                ...
                                .addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onCancelled(@NonNull DatabaseError databaseError) {
                                        Toast.makeText(TrainActivity.this,"Firebase Database Error",Toast.LENGTH_LONG).show();
                                    }
                                });
    ...
    public void onClick(View view, int position) {
        ...
        Intent intent=new Intent(TrainActivity.this,SeatActivity.class);
