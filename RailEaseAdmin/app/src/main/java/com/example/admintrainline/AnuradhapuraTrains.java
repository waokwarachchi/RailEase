...
public class AnuradhapuraTrains extends AppCompatActivity {
    ...
    private FirebaseHelper2 firebaseHelper = new FirebaseHelper2(DRIVER_ID);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.anuradapuratrains);
